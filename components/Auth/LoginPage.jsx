      ...
      if (token) {
        ...
        try {
          ...
          if (userId) {
            ...
            console.warn(
              "No userId found in AsyncStorage, skipping FCM token backend update"
            );
          }
        } catch (error) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.log("Sending login data:", {
        emailOrContact: loginData.emailOrContact,
        password: "[HIDDEN]",
      });
      ...
      if (error.response) {
        ...
        if (status === 400) {
          ...
          errorMessage =
            "Account is blocked or inactive. Please contact support.";
        } else if (status === 404) {
          errorMessage =
