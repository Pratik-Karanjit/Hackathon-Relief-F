...
export default function AdminAddOrganization() {
  ...
  const handleSubmit = async () => {
    ...
    const orgPayload = {
      ...
      organizationType: formData.orgType.toUpperCase(),
    };
    ...
    try {
      const response = await api.post("/user/signup/organization", form, {
        headers: {
        ...
        Alert.alert("Success", "Organization created successfully!", [
          {
            text: "OK",
            onPress: () => {
              navigationRef.navigate("AdminTabs", {
                screen: "AdminHome",
              });
            },
          },
      ...
      Alert.alert("Error", "Failed to register organization.");
    }
  };
